...
class WebContentSummarizeAgent(SummarizeTask):
    ...
    OUTPUT_PATH = './data/patterns/web_search/output/summarize/summary.md'
    ...
    def save(self, summary: str, query: str, model_name: str) -> None:
        """
        Saves the generated summary to a file in Markdown format.

        Args:
            summary (str): The generated summary to be saved.
            query (str): The query used for the summarization.
        ...
        try:
            ...
            markdown_content = f"""# Web Content Summary
...
---
Generated by WebContentSummarizeAgent
"""

            with open(self.OUTPUT_PATH, 'w', encoding='utf-8') as file:
                file.write(markdown_content)
            
            logger.info("Summary saved successfully in Markdown format.")
        except Exception as e:
