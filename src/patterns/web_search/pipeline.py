...
class Pipeline:
    ...
    Attributes:
        search_task (SearchTask): The task responsible for performing web searches based on the query.
        scrape_task (ScrapeTask): The task responsible for scraping web content from search results.
